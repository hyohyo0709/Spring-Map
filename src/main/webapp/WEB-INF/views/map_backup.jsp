...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=d71c48284a7aa409dcf17d1dea29abe8"></script>
...
<div id="menu_wrap" class="bg_white">
			<div class="option">
				<form onsubmit="searchPlaces(); return false">
					<span>지역명:</span> <input type="text" name="keyword" value=" ex) 서울" id="keyword"
						size="15" />
